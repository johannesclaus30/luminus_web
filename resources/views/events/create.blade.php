...
<head>
    ...
    <title>{{ $event->exists ? 'Edit Event' : 'Create Event' }} | LumiNUs Admin</title>
            ...
            <header class="page-header">
                <div class="header-content">
                    <div class="header-title-section">
                        <h1 class="page-title">
                            <i class="fa-solid {{ $event->exists ? 'fa-pen-to-square' : 'fa-plus-circle' }}"></i>
                            {{ $event->exists ? 'Edit Event' : 'Create Event' }}
                        </h1>
                        <p class="page-subtitle">{{ $event->exists ? 'Update event details for NU Lipa alumni' : 'Organize a new event for NU Lipa alumni' }}</p>
                    </div>
                    ...
                    <div class="form-right-panel">
                                ...
                                @if($event->exists && $event->images)
                                    @foreach($event->images as $image)
                                        <div class="attachment-item existing-image">
                                            ...
                                            <button type="button" class="remove-attachment-btn" onclick="removeExistingImage(this, {{ $image->id }})" title="Remove">
                                                <i class="fa-solid fa-xmark"></i>
                                            </button>
                                        </div>
                                    @endforeach
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fa-solid {{ $event->exists ? 'fa-save' : 'fa-plus' }}"></i>
                                <span>{{ $event->exists ? 'Update Event' : 'Create Event' }}</span>
                            </button>
                        </div>
                    </div>
                </div>
