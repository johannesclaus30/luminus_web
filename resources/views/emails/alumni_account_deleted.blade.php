...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="category-tag">Account Removed</div>

            <h1 class="welcome-title">Your Alumni Account Has Been Deleted</h1>

            <p class="greeting">Hello {{ $alumnusName }},</p>
            
            <p>This is an automated notification to inform you that your alumni account on the LumiNUs platform has been permanently deleted.</p>
            
            <div class="details-card">
                <table>
                    <tr>
                        <td class="label">Deleted By</td>
                        <td class="value">{{ $deletedBy }}</td>
                    </tr>
                    <tr>
                        <td class="label">Account Status</td>
                        <td class="value" style="color: #dc2626; font-weight: 700;">❌ Permanently Deleted</td>
                    </tr>
                </table>
            </div>

            <p>You will no longer be able to access your account or any associated data within the LumiNUs alumni platform.</p>

            <div class="warning-box">
                ⚠️ <strong>Need Assistance?</strong> If you believe your account was deleted in error, please contact the <strong>NU Lipa Alumni Affairs Office</strong> immediately.
            </div>
